...
@section('content')
  ...
  <form action="{{route('setting.update', ['setting' => $setting->id])}}" method="post">
    ...
    <div class="mb-2">
      ...
      <input type="text" disabled name="key" value="{{old('key', $setting->key)}}" id="key" class="form-control @error('key') is-invalid @enderror">
      @error('key')
    ...
    <div class="mb-2">
      ...
      <input type="text" name="value" value="{{old('value', $setting->value)}}" id="value" class="form-control @error('value') is-invalid @enderror">
      @error('value')
        <div class="text-danger">{{$message}}</div>
      @enderror
    </div>
